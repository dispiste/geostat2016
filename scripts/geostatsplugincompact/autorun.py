...
def main():
    ...
    process1.selfregister("Scripting")
    #process1.updateToolbox() #not necessary at startup
    process2 = TestProcess3()
    process2.selfregister("Scripting")
    #process2.updateToolbox() #not necessary at startup
